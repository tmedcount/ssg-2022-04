...
INSERT INTO `article` VALUES (1,'2022-04-10 10:15:33','2022-04-13 18:04:28','1강, SELECT 👼','# SELECT 😇\r\n- 데이터 조회 기능\r\n\r\n# SELECT 예시\r\n```sql\r\nSELECT `column_name`,\r\nFROM `table_name`\r\nWHERE `column_name` > 1 # 조건\r\n```\r\n',1,3,1,2),(2,'2022-04-10 10:18:53','2022-04-13 18:04:28','2강, INSERT','# INSERT\r\n- 데이터 삽입 기능\r\n\r\n# INSERT 예시\r\n```sql\r\nINSERT INTO `table_name`,\r\nSET `column1_name`  = `value1`,\r\n`column2_name`  = `value2`\r\n```\r\n',1,3,0,0);
...
-- Dump completed on 2022-04-13 18:05:37
